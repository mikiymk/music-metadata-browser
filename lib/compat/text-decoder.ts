...
/**
 * decode uint8 array as UTF-16 Big Endian formatted string
 * @param uint8array bytes
 * @returns decoded string
 */
export function decodeUtf16be(uint8array: Uint8Array): string {
  const decodedString = utf16beDecoder.decode(uint8array);
  return decodedString;
}
