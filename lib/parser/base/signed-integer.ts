 ...
 */
export const readInt8 = (buffer: Uint8Array, offset: number): number => {
 ...
 */
export const readInt16le = (buffer: Uint8Array, offset: number): number => {
 ...
 */
export const readInt16be = (buffer: Uint8Array, offset: number): number => {
 ...
 */
export const readInt24le = (buffer: Uint8Array, offset: number): number => {
  const result = readUint24le(buffer, offset);

  return result > 0x7f_ff_ff ? result - 0x1_00_00_00 : result;
};
 ...
 */
export const readInt24be = (buffer: Uint8Array, offset: number): number => {
 ...
 */
export const readInt32be = (buffer: Uint8Array, offset: number): number => {
 ...
 */
export const readInt64le = (buffer: Uint8Array, offset: number): bigint => {
 ...
 */
export const readInt64be = (buffer: Uint8Array, offset: number): bigint => {
