...
export declare type ReadableStreamWithFileType = ReadableStream & {
 ...
 * @returns The detected file type and MIME type, or `undefined` when there is no match.
 */
export declare function fileTypeFromBuffer(input: Uint8Array | ArrayBuffer): Promise<FileTypeResult | undefined>;
/**
 ...
 * ```
 */
export declare function fileTypeFromTokenizer(tokenizer: ITokenizer): Promise<FileTypeResult | undefined>;
/**
 ...
 * ```
 */
export declare function fileTypeStream(readableStream: ReadableStream, { sampleSize }?: StreamOptions): Promise<ReadableStreamWithFileType>;
/**
 * Supported file extensions.
 */
export declare const supportedExtensions: ReadonlySet<FileExtension>;
/**
 * Supported MIME types.
 */
export declare const supportedMimeTypes: ReadonlySet<MimeType>;
