...
export class FilePropertiesObject extends State {
    static guid = GUID.FilePropertiesObject;
    constructor(header) {
        super(header);
    }
    get(buf, off) {
...
export class StreamPropertiesObject extends State {
    static guid = GUID.StreamPropertiesObject;
    constructor(header) {
        super(header);
    }
    get(buf, off) {
...
export class HeaderExtensionObject {
    static guid = GUID.HeaderExtensionObject;
    len;
    constructor() {
        this.len = 22;
    }
...
export class ContentDescriptionObjectState extends State {
    static guid = GUID.ContentDescriptionObject;
    static contentDescTags = [
        "Title",
        "Author",
        "Copyright",
        "Description",
...
export class ExtendedContentDescriptionObjectState extends State {
    static guid = GUID.ExtendedContentDescriptionObject;
    constructor(header) {
        super(header);
    }
    get(buf, off) {
...
export class ExtendedStreamPropertiesObjectState extends State {
    static guid = GUID.ExtendedStreamPropertiesObject;
    constructor(header) {
        super(header);
    }
    get(buf, off) {
...
export class MetadataObjectState extends State {
    static guid = GUID.MetadataObject;
    constructor(header) {
        super(header);
    }
    get(uint8Array, off) {
...
export class MetadataLibraryObjectState extends MetadataObjectState {
    static guid = GUID.MetadataLibraryObject;
    constructor(header) {
        super(header);
    }
}
